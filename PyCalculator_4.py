...
class PyCalculator_1():
    def __init__(self, master=None, **configs):
        ...
        title_label=Button(self.area1, text="[   Basic Calculator    ]", bg="#2F4F4F", fg="white", command=self.info)
        title_label.pack(side=LEFT, expand=NO, fill=None)
        b0 = Button(self.buttons_section, text="0", width= 7, height=2, bg="#2F4F4F", fg="white", command=lambda:self.printNum('0')).grid(column=0, row=6)
        b1 = Button(self.buttons_section, text="1", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('1')).grid(column=0,row=5)
        b2 = Button(self.buttons_section, text="2", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('2')).grid(column=1,row=5)
        b3 = Button(self.buttons_section, text="3", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('3')).grid(column=2,row=5)
        b4 = Button(self.buttons_section, text="4", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('4')).grid(column=0, row=4)
        b5 = Button(self.buttons_section, text="5", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('5')).grid(column=1, row=4)
        b6 = Button(self.buttons_section, text="6", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('6')).grid(column=2, row=4)
        b7=Button(self.buttons_section, text="7", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('7')).grid(column=0, row=3)
        b8=Button(self.buttons_section, text="8", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda: self.printNum('8')).grid(column=1, row=3)
        b9=Button(self.buttons_section, text="9", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda:self.printNum('9')).grid(column=2, row=3)
        ...
        delete=Button(self.buttons_section, text="C", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda:self.clear()).grid(column=1, row=6)
        equal=Button(self.buttons_section, text="=", width=7, height=2, bg="#2F4F4F", fg="white", command=lambda:self.modify('=')).grid(column=2, row=6)
